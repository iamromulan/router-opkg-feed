...
```
https://raw.githubusercontent.com/iamromulan/router-opkg-feed/Hiveton-H5000M/opkg-feed/iamromulan-hiveton-h5000m_1.1_aarch64_cortex-a53.ipk
```

Then click "Update Lists" to refresh the available packages.
